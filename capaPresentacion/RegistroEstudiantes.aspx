...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_Estudiante" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None">
              ...
              <div class="modal-content">
                ...
                <!-- Body -->
                  ...
                  <div class="modal-body">
                      ...
                      <asp:Button type="submit" Text="Eliminar" />
                  </div>
              </div>
            </div>
        </div>
